 ...
 */
public class SettingActivity extends PreferenceActivity {//preference設定介面 可以自動儲存修改的設定
    @Override
     ...
     */
    public static class ColorSettings extends PreferenceFragment {//在res/xml資料夾裡 的設定
        @Override
